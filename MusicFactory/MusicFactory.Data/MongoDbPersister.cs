namespace MusicFactory.Data
{
    ...
    public class MongoDbPersister
    {
        ...
        public void SaveData()
        {
            ...
            var song1 = new SongMongoDbProjection() { Title = "SOong1", Duration = 3,};
            var song2 = new SongMongoDbProjection() { Title = "SOon2", Duration = 31,};
            var song3 = new SongMongoDbProjection() { Title = "SOong33333333", Duration = 72};
            List<SongMongoDbProjection> songs = new List<SongMongoDbProjection> { song1, song2, song3 };

            var album =
                new AlbumMongoDbProjection() { AlbumTitle = "Rap god!", ReleaseDate = DateTime.Now, AlbumPrice = 5.2m, ArtistName ="Eminem", Songs = songs , ArtistLabel = "Universal"};
